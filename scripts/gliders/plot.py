...
def plot_raw(classification_file,categorize_file):
    classification, categorize, date, site = utils.open_files(classification_file, categorize_file)
...
def plot_cbt(classification_file, categorize_file):
    ...
    cla, cat, date, site = utils.open_files(classification_file, categorize_file)
    
    cbh, cth = utils.get_height(cla)
